            ...
            if (importMethod === 'mnemonic') {
                ...
                if (network === 'BTC') {
                    ...
                    try {
                        ...
                        let secretKey;
                        // Solana private keys can be hex (128 chars) or base58
                        ...
                        console.log(`[SOL:Import] Imported wallet: ${address}`);
                    } catch (err) {
                        return res.status(400).json({ message: "Invalid Solana private key: " + err.message });
                    }
                } else if (network === 'TRX' || network === 'USDT_TRC20') {
